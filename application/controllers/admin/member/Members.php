	...
	public function write($pid = 0)
	{
		...
		if ($this->input->post($primary_key)) {
			$config[] = array(
				'field' => 'mem_userid',
				'label' => '회원아이디',
				'rules' => 'trim|required|alphanumunder|min_length[3]|max_length[50]|is_unique[member_userid.mem_userid.mem_id.' . element('mem_id', $getdata) . ']|callback__mem_userid_check',
			);
			$config[] = array(
				'field' => 'mem_password',
				'label' => '패스워드',
