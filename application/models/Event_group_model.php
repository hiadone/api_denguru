...
class Event_group_model extends CB_Model
{
    ...
    public $_select = 'egr_id,egr_start_date,egr_end_date,egr_title,egr_datetime,egr_image,egr_detail_image,egr_content,egr_activated,egr_type'; // 사용되는 테이블의 프라이머리키
