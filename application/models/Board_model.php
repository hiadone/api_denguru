...
class Board_model extends CB_Model
{
	...
	public $allow_order = array('cit_order asc', 'cit_datetime desc', 'cit_datetime asc', 'cit_hit desc', 'cit_hit asc', 'cit_review_count desc',
		'cit_review_count asc', 'cit_review_average desc', 'cit_review_average asc', 'cit_price desc', 'cit_price asc', 'cit_sell_count desc','brd_order asc','rand()','(0.1/cit_order)','(0.1/cit_order1)','(0.1/cit_order2)','(0.1/cit_order3)','(0.1/cit_order4)');
